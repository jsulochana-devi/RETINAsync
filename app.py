"""RETINAsync Main Entry Point
Explainable AI for Diabetic Retinopathy Screening in Rural India
Smart India Hackathon 2026 | SIH26038

Architecture: UI modules live in views/ and routing uses st.session_state["page"].
"""
import streamlit as st
from backend.database import init_db, authenticate_user
from backend.i18n import t, get_workflow_speech_text
